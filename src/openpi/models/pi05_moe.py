"""Pi05MoE — pi0.5 with a Mixture-of-Experts action expert.

This preserves the existing pi0.5 MoE behavior. The action expert FFN is
replaced with an MoE FFN, and the suffix path remains the pi0.5-specific
action-only + adaRMS timestep-conditioning path.
"""
...
if TYPE_CHECKING:
    from openpi.models.pi05_moe_config import Pi05MoEConfig

logger = logging.getLogger("openpi")


class Pi05MoE(_model.BaseModel):
    def __init__(self, config: Pi05MoEConfig, rngs: nnx.Rngs):
