"""Pi0ResidualMoE — pi0 with a dense base FFN plus a routed residual MoE branch.

This preserves the dense pi0 suffix path:
  ...
  - the action expert FFN becomes `dense_base + routed_small_expert`
"""
...
if TYPE_CHECKING:
    from openpi.models.pi0_residual_moe_config import Pi0ResidualMoEConfig

logger = logging.getLogger("openpi")


class Pi0ResidualMoE(_model.BaseModel):
    def __init__(self, config: Pi0ResidualMoEConfig, rngs: nnx.Rngs):
