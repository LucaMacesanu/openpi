...
from openpi.models.pi0 import posemb_sincos  # noqa: E402
    ...
    def _compute_loss(
        ...
        *,
        ...
        if return_moe_metrics:
            (prefix_out, suffix_out), _, total_z_loss, total_load_balance_loss, moe_metrics = llm_out
        else:
            (prefix_out, suffix_out), _, total_z_loss, total_load_balance_loss = llm_out
